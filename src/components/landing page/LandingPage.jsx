...
import FinancesAndBanking from '../../assets/homepage/Card 1 Finances and Banking.png';
import MarketingAndSEO from '../../assets/homepage/Card 2 Marketing and SEO.png';
import ContentAndCreative from '../../assets/homepage/Card 3 Content and Creative.png';
import DesignAndDev from '../../assets/homepage/Card 4 Design and Dev.png';
import HiringFirms from '../../assets/homepage/Card 5 Hiring Firms.png';
                ...
                <Container>
                    ...
                    <Row>
                        ...
                        <div className = "search__compare">
                            ...
                            <p>Post your services, accelerate your business.</p>
                        ...
                        <div className = "search__field">
                            ...
                            <Dropdown>
                                <Dropdown.Toggle className = "search__field__tab" id="dropdown-basic" style = {{boxShadow: "4px 3px 2px #EFEFEF29", border: "1px solid #EEEEEE", borderRadius: "7px", opacity: "1", backgroundColor: "#fcfcfc", color: "rgba(43, 42, 53, 0.59)"}}>
                                    All 
                                </Dropdown.Toggle>
                            ...
                            <Form inline>
                                ...
                                <Button style = {{boxShadow: "4px 3px 2px #EFEFEF29", border: "1px solid #EEEEEE", borderRadius: "7px", opacity: "1", backgroundColor: "#fcfcfc"}}><AiOutlineSearch style = {{fill: "#334ac0"}}/></Button>
                        ...
                        <p className = "section__details">Search for products, compare and buy all at one place.</p>
                        ...
                        <p className = "section__details">Boost productivity</p>
                        ...
                        <p className = "section__details">Compare, connect and buy all services at one place.</p>
